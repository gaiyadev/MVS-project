  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">         
          <a href="sss1c-add.php" style="color: #fff;" class="btn-primary btn">Add Student <span class="fa fa-plus"></span></a>
        </li>
        <li class="breadcrumb-item" style="color: #fff;" >SSS1 C</li>
      </ol>
