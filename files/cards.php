...
<body class="fixed-nav sticky-footer" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark  fixed-top" id="mainNav">
    <a class="navbar-brand" href="cards.php">I. C. T. Officer </a>
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="messagesDropdown">
            <h6 class="dropdown-header" style="background-color: #2874B2; color: #fff;">New Messages:</h6>
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="cards.php" style="color: #fff;">Dashboard</a>
        </li>
      ...
      <div class="row" style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white  o-hidden h-100" style="background-color: #2b3873;">
            ...
            <a class="card-footer text-white clearfix small z-1" href="scienceclass.php" target="_blank">
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white o-hidden h-100" style="background-color: #3871ac;">
            ...
            <a class="card-footer text-white clearfix small z-1" href="artclass.php">
              <span class="float-left">Register</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white  o-hidden h-100" style="background-color:  #2b3873;">
            ...
            <a class="card-footer text-white clearfix small z-1" href="commercialclass.php">
              <span class="float-left">Register</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-3 col-sm-6 mb-3">
          <div class="card text-white  o-hidden h-100" style="background-color: #3871ac; ">
            ...
            <a class="card-footer text-white clearfix small z-1" href="juniors.php">
              <span class="float-left">Register</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
