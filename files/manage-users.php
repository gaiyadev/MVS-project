...
<body class="fixed-nav sticky-footer " id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark  fixed-top" id="mainNav">
    <a class="navbar-brand" href="tables.php">I. C. T. Officer </a>
      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion" style="background-color: #2b3873;">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="tables.php">
            ...
            <span class="nav-link-text" style="color: #fff;">Tables</span>
          </a>
        </li>
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="cards.php" style="color: #fff;" data-toggle="popover" title="Home">Home</a>
        </li>
        <li class="breadcrumb-item">
          <a href="tables.php" style="color: #fff;" data-toggle="popover" title="View Users">View Users</a>
        </li>
        <li class="breadcrumb-item active" style="color: gold;">Update/Delete.</li>         
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header" style="background-color: ; color: ; border: none;"  >
          <i class="fa fa-table" ></i> List of All Users</div>
        <div class="card-body">
            ...
            <table class="table  table-striped" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody style="background-color:;">
                <tr>
                  ...
                  <td>admin</td>
                  <td><a href="update-user.php" data-toggle="popover" title="Update User" style="margin-left: 20px;"><span class="fa fa-edit"></span></a> <a href="#" data-toggle="popover" title="Delete User" style="margin-left: 20px;"><span class="fa fa-trash"></span></a></td>
                </tr>
              </tbody>
            </table>
          </div>
