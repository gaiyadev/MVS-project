  ...
  <div class="container-fluid">
    ...
    <form class="form-signin" action="#" method="post" >
      <img src="img/user.png" class="img-responsive img-circle" width="100" height="100" align="center">
         ...
         <div class="input-group form-group-lg">
             <span class="input-group-addon" style="background-color: #3481B8; color: #fff; border: none;">
                <span class="glyphicon glyphicon-user"></span>
                     ...
                     <input type="text" class="form-control" placeholder="Username " required="required" autofocus="autofocus"  minlength="5" maxlength="20">
          </div> <!-- /end -->
          ...
          <div class="input-group form-group-lg">
             <span class="input-group-addon" style="background-color: #3481B8; color: #fff; border: none;">
                ...
                <input type="password" class="form-control" placeholder="Password " required="required" minlength="10" maxlength="20">
          </div> <!-- /end -->
        ...
        <button class="btn btn-lg btn-default btn-block" type="submit" name="login">Login</button>
        <br/>
        <p>Search for your results?<a href="result-login.php" style="color: #fff; font-size: 1.3em;" target="_blank">  Click Here</a></p>
      </form>

     
  </div> <!-- /cntainer -->
  <marquee  class="text-capitalize" style=" background-color: #3481B8; color: #fff; padding: 10px; box-sizing: border-box; font-weight: 1000px; width: 100%; font-size: 1.4em;">
        Welcome  to your administrator login page
        ... Please remember to keep your login details save in order to prevent hackers from accesesing your school portal...best wishes from the team.
    </marquee>
<br/>
