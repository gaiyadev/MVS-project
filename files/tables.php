    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="cards.php" style="color: #fff;">Home</a>
        </li>
        <li class="breadcrumb-item">
          <a href="manage-users.php" style="color: #fff;">Update/Delete</a>
        </li>
        <li class="breadcrumb-item active" style="color: gold;">Users Tables</li>         
      </ol>
